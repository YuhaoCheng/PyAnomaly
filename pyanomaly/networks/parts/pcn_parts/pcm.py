...
#     def forward(self, x):
#         x1 = self.h1(x)
#         x1 = self.h1_pooling(x1)
#         x2 = self.h2(x1)
#         x2 = self.h2_pooling(x2)
#         x3 = self.h3(x2)
#         x3 = self.h3_pooling(x3)
#         x4 = self.h4(x3)
