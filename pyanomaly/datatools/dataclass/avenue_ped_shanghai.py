...
def _get_test_dataset(cfg, aug):
    ...
    for t_dir in video_dirs:
        ...
        # dataset = AvenuePedShanghaiOneVideo(_temp_test_folder, clip_length=cfg.DATASET.test_clip_length, sampled_clip_length=cfg.DATASET.test_sampled_clip_length,clip_step=cfg.DATASET.test_clip_step, frame_step=cfg.DATASET.test_frame_step,transforms=aug, one_video=True, cfg=cfg)
        dataset = AvenuePedShanghaiAll(_temp_test_folder, clip_length=cfg.DATASET.test_clip_length, sampled_clip_length=cfg.DATASET.test_sampled_clip_length,clip_step=cfg.DATASET.test_clip_step, frame_step=cfg.DATASET.test_frame_step,transforms=aug, one_video=True, cfg=cfg)
...
def _get_train_w_dataset(cfg, aug):
    ...
    for t_dir in video_dirs:
        ...
        if cfg.DATASET.name == 'shanghai':
            ...
            dataset = AvenuePedShanghaiAll(_temp_test_folder, clip_length=cfg.DATASET.test_clip_length, sampled_clip_length=cfg.DATASET.test_sampled_clip_length, clip_step=cfg.DATASET.test_clip_step, frame_step=cfg.DATASET.test_frame_step, one_video=True, mini=True, transforms=aug, cfg=cfg)
            ...
            dataset = AvenuePedShanghaiAll(_temp_test_folder, clip_length=cfg.DATASET.train_clip_length, sampled_clip_length=cfg.DATASET.train_sampled_clip_length, clip_step=cfg.DATASET.train_clip_step, frame_step=cfg.DATASET.train_frame_step,transforms=aug, one_video=True, cfg=cfg)
        dataset_list[t_dir] = dataset
    video_keys = list(dataset_list.keys())
    return (dataset_list, video_keys)
...
def _get_cluster_dataset(cfg, aug):
    ...
    for t_dir in video_dirs:
        ...
        dataset = AvenuePedShanghaiAll(_temp_train_folder, clip_length=cfg.DATASET.train_clip_length, sampled_clip_length=cfg.DATASET.train_sampled_clip_length, clip_step=cfg.DATASET.train_clip_step, frame_step=cfg.DATASET.train_frame_step,is_training=True, transforms=aug, one_video=True, cfg=cfg)
        dataset_list[t_dir] = dataset
    video_keys = list(dataset_list.keys())
    return (dataset_list, video_keys)
...
def get_avenue_ped_shanghai(cfg, flag, aug):
    ...
    '''
    if flag == 'train':
        t = AvenuePedShanghaiAll(cfg.DATASET.train_path, clip_length=cfg.DATASET.train_clip_length, sampled_clip_length=cfg.DATASET.train_sampled_clip_length, clip_step=cfg.DATASET.train_clip_step, frame_step=cfg.DATASET.train_frame_step,transforms=aug, cfg=cfg)
    elif flag == 'val':
        ...
        t = AvenuePedShanghaiAll(cfg.DATASET.test_path, clip_length=cfg.DATASET.test_clip_length, sampled_clip_length=cfg.DATASET.test_sampled_clip_length, clip_step=cfg.DATASET.test_clip_step, frame_step=cfg.DATASET.test_frame_step, transforms=aug, mini=True, cfg=cfg)
