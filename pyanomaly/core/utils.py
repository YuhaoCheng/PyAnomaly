...
def save_results(cfg, logger, verbose=None, config_name='None', current_step=0, time_stamp='time_step', **kwargs): # need to remove the kwarg, fix the name of parameters
